<style>
    ...
    .btn-save { background: #6366f1; color: white; padding: 12px 24px; border: none; border-radius: 8px; font-weight: bold; cursor: pointer; font-size: 1rem; transition: background 0.2s; }
    .btn-save:hover { background: #4f46e5; }
    .btn-cancel { color: #64748b; text-decoration: none; font-size: 0.95rem; }
    .btn-cancel:hover { text-decoration: underline; }
    
    .error-box { background: #fef2f2; border-left: 4px solid #ef4444; padding: 15px; margin-bottom: 20px; border-radius: 4px; }
    .error-box ul { margin: 0; padding-left: 20px; color: #b91c1c; font-size: 0.9rem; }
</style>
...
<div class="form-container">
    ...
    <form method="POST" action="{{ route('students.store') }}">
        ...
        <div class="button-group">
            ...
            <a href="{{ route('students.index') }}" class="btn-cancel">Cancel and Go Back</a>
        </div>
    </form>
</div>